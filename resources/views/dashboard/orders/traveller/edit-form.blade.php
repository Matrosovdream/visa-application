<form method="POST"
    action="{{ route('dashboard.orders.traveller.update', ['order' => $order->id, 'traveller' => $traveller['id']]) }}">
    @csrf
                            ...
                            @foreach($travellerFields[$cat['slug']] as $field_slug => $field)
                                ...
                                <tr>
                                    <td class="text-start text-gray-800">
                                        @include('dashboard.orders.partials.applicant-field', ['code' => $field_slug, 'field' => $field, 'traveller' => $traveller])
                                    </td>
                                </tr>
