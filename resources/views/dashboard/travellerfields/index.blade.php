...
<div class="card card-flush">
    ...
    <form action="{{ route('dashboard.travellerfields.index') }}" method="GET">
        ...
        <div class="card-header align-items-center py-5 gap-2 gap-md-5">
            ...
            <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                ...
                <a href="{{ route('dashboard.travellerfields.create') }}" class="btn btn-primary">Add field</a>
            </div>
        </div>
            ...
            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_products_table">
                ...
                <tbody class="fw-semibold text-gray-600">
                    ...
                    @foreach($items as $item)
                        ...
                        <tr>
                            <td>
                                <a href="{{ route('dashboard.travellerfields.show', $item->id) }}"
                            ...
                            <td class="text-center">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                    ...
                                    <div class="menu-item px-3">
                                        <form action="{{ route('dashboard.travellerfields.destroy', $item->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
