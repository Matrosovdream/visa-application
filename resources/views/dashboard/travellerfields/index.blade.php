    ...
    <form action="{{ route('dashboard.travellerfields.index') }}" method="GET">
        ...
        <div class="card-header align-items-center py-5 gap-2 gap-md-5">
            ...
            <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                ...
                <a href="{{ route('dashboard.travellerfields.create') }}" class="btn btn-primary">Add article</a>
            </div>
        </div>
                ...
                <tbody class="fw-semibold text-gray-600">
                    ...
                    @foreach($articles as $article)
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('dashboard.travellerfields.show', $article->id) }}"
                            ...
                            <td class="text-center">
                                <a href="{{ route('dashboard.travellerfields.show', $article->author_id) }}"
                                    class="text-gray-800 text-hover-primary fs-5 fw-bold"
                                    data-kt-ecommerce-product-filter="product_name">
                                    {{ $article->author->name }}
                                </a>
