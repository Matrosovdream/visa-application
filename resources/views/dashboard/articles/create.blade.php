...
@section('content')
    ...
    <form class="form" method="POST" action="{{ route('dashboard.articles.store') }}">
        @csrf
                            ...
                            <div class="card-body pt-0 pb-5">
                                    ...
                                    <div class="col-lg-8 d-flex align-items-center">
                                        <div class="form-check form-check-solid form-switch form-check-custom fv-row">
                                            <input class="form-check-input w-45px h-30px" type="checkbox" name="published"
                                                id="published" value="1" {{ old('published') ? 'checked' : '' }} />
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <textarea name="short_description" class="form-control form-control-solid"
                                        placeholder="" style="height: 100px;">{{ old('short_description') }}</textarea>
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <textarea name="summary" class="form-control form-control-solid" id="kceditor-summary"
                                        style="height: 200px;" placeholder="">{{ old('summary') }}</textarea>
                                </div>
                            ...
                            <div class="card-body pt-0 pb-5">
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <textarea name="content" class="form-control form-control-solid" id="kceditor-content"
                                        placeholder="" style="height: 800px;">{{ old('content') }}</textarea>
                                </div>
